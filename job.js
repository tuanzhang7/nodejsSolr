        ...
        function (callback) {
            ...
            async.waterfall([
                ...
                function(nodeIdList,transactionsArray, callback) {
                    getStoreArrays(nodeIdList,chunksSize,getMetadataThreads,function (err,workspaceArray,archiveArray) {
                        callback(null, workspaceArray,archiveArray,transactionsArray,upsert);
                    });
                },
                saveToDB
            ], function (err, result) {
...
function saveToDB(workspaceArray,archiveArray,transactionsArray,upsert, callback) {
...
function getStoreArrays(nodeIdList,chunksSize,getMetadataThreads, callback) {
    var workspaceArray=[];
    var archiveArray=[];
    ...
    async.eachLimit(chunks,getMetadataThreads, function (chunkArray,callback) {
        ...
        callback(null, workspaceArray,archiveArray);
    });
};
exports.getStoreArrays=getStoreArrays;
